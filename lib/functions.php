 ...
 * 把源图片转换成webp图片
 *
 * @param string $source_image_path 源图片文件路径
 * @param string $new_webp_image_path 新生成webp文件的路径
 * @return void
 * @throws Exception
 */
function create_webp_file($source_image_path, $new_webp_image_path)
{
    //从配置里获取压缩质量
    ...
    if (!$info)
    {
        throw new Exception("图片信息错误: $source_image_path");
    }
